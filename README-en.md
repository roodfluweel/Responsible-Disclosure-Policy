...
* Report the vulnerability as soon as possible after discovery. Mail your findings to support@roodfluweel.be or if needed, to infosec@roodfluweel.be and encrypt them with our [PGP key](infosecRoodFluweel_0x294BE3EC_public.asc) to prevent the information from falling into the wrong hands.
